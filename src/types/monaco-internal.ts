/* eslint-disable */
/**
 * These types are taken from `out/release/typescript.d.ts` in the monaco project.
 * To get that file, you must clone the `monaco-editor` project and build a release bundle!
 *
 * Note that this comes from `out`, not `release`. Only the data in `release` is actually packaged, while
 * `out` is just intermediate build steps.
 */
/*---------------------------------------------------------------------------------------------
...
import type { IDisposable, IEvent } from 'monaco-editor';
